...
<head>
  ...
  <script src="https://kit.fontawesome.com/c3e0625efe.js" crossorigin="anonymous"></script>
</head>
<style>
    body {
...
<body>
  <nav class="navbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a href="premiumimg.php" class="nav-link">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
          ...
          <span class="link-text">Image File</span>
        </a>
      </li>
  ...
  <main>
    ...
    <!-- <a class="golo" href="changepage.php">Change Password</a>
    <a class="golo" href="loginpage.php">Log Out</a> -->
    <div class="hall">
    <div class="wrapper">
  ...
  <script src="scripts/textalgo.js"></script>
